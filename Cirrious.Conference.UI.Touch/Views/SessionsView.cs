...
namespace Cirrious.Conference.UI.Touch
{
        ...
        : MvxViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            this.AddBindings(new Dictionary<object, string>()
			    {
					...
					{ Button1, "Title TextSource,Converter=Language, ConverterParameter='Day1'" },				
					{ Button2, "Title TextSource,Converter=Language, ConverterParameter='Day2'" },				
					{ Button3, "Title TextSource,Converter=Language, ConverterParameter='Day3'" },				
            ...
            this.AddBindings(new Dictionary<object, string>()
			    {
					{ Button1, "TouchUpInside ShowDay1Command" },				
					{ Button2, "TouchUpInside ShowDay2Command" },				
					{ Button3, "TouchUpInside ShowDay3Command" },				
